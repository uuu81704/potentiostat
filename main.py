...
class serialPlot:
    ...
    def write_read(self):
        num = input("Enter setting current [A]: ")
        self.serialConnection.write(bytes(num, 'utf-8'))
        time.sleep(0.02)
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText):
        ...
        for i in range(self.numPlots):
            ...
            lineValueText[i].set_text('[' + lineLabel[i] + '] = ' + str(round(value,3)))
